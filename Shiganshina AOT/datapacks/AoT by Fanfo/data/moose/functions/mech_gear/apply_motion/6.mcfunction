...
execute store result entity @s Motion[0] double 0.01 run scoreboard players operation @s motion_x2_6 -= @s motion_x1_6
execute store result entity @s Motion[1] double 0.01 run scoreboard players operation @s motion_y2_6 -= @s motion_y1_6
execute store result entity @s Motion[2] double 0.01 run scoreboard players operation @s motion_z2_6 -= @s motion_z1_6
