...
execute as @s[scores={atk_cool=112}] at @s run effect give @p[tag=wrap] instant_damage 999 5 true
execute as @s[scores={atk_cool=112}] at @s run execute as @p[tag=wrap] at @s run particle minecraft:block minecraft:redstone_block ^ ^1 ^ 0 0 0 1 30
execute as @s[scores={atk_cool=112}] at @s run execute as @p[tag=wrap] at @s run particle minecraft:block minecraft:pink_terracotta ^ ^1 ^ 0 0 0 1 20
