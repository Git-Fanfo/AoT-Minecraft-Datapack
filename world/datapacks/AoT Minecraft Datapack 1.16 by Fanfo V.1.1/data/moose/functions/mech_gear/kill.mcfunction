...
execute at @e[type=bat,tag=rope_1,sort=nearest,nbt=!{Leash:{}},limit=1] run kill @e[tag=hook_1,limit=1, sort=nearest]
...
#----------------------------------------
# KILL GANCHO DERECHA
execute at @e[type=bat,tag=rope_6,sort=nearest,nbt=!{Leash:{}},limit=1] run kill @e[tag=hook_6,limit=1, sort=nearest]
