...
execute if score spawn_c counter matches 2 run function moose:titans/summon/titan_3
execute if score spawn_c counter matches 3 run function moose:titans/summon/titan_4
...
#Reset
execute if score spawn_c counter matches 4 run scoreboard players set spawn_c counter 0