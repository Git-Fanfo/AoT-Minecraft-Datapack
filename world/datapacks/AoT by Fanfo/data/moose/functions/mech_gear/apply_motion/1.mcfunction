...
execute store result entity @s Motion[0] double 0.04 run scoreboard players operation @s motion_x2_1 -= @s motion_x1_1
execute store result entity @s Motion[1] double 0.04 run scoreboard players operation @s motion_y2_1 -= @s motion_y1_1
execute store result entity @s Motion[2] double 0.04 run scoreboard players operation @s motion_z2_1 -= @s motion_z1_1
