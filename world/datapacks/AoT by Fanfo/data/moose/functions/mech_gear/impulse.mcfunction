execute as @s[scores={man_land=2..}] run summon area_effect_cloud ^ ^.5 ^.5 {Particle:"explosion",NoGravity:1b,ReapplicationDelay:0,Radius:1.5f,Duration:15,Effects:[{Id:25b,Amplifier:28b,Duration:7}]}
...
execute as @s[scores={man_land=2..,near=0}] run summon creeper ^ ^.45 ^-1.7 {NoGravity:1b,Silent:1b,Invulnerable:1b,Fuse:0,Tags:["motion"]}
execute as @s[scores={man_land=2..,near=0}] run summon creeper ^ ^.45 ^-1.7 {NoGravity:1b,Silent:1b,Invulnerable:1b,Fuse:0,Tags:["motion"]}
