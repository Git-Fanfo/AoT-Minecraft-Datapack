...
# KILL 3D DERECHA
execute at @s run kill @e[distance=0..4,tag=3D_1,type=armor_stand,limit=1, sort=nearest]
execute at @s run kill @e[distance=0..4,tag=3Dhook_1,type=bat,limit=1, sort=nearest]
...
# KILL 3D DERECHA
execute at @s run kill @e[distance=0..4,tag=3D_6,type=armor_stand,limit=1, sort=nearest]
execute at @s run kill @e[distance=0..4,tag=3Dhook_6,type=bat,limit=1, sort=nearest]
