...
execute if score titan_c counter matches 0 run summon zombie_villager ~ ~ ~ {Fire:3,Silent:1b,Invulnerable:1b,CustomNameVisible:0b,PersistenceRequired:1b,Tags:["feet","titan"],Passengers:[{id:"minecraft:slime",Fire:100,HasVisualFire:1b,Silent:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,Size:8,Tags:["legs","titan"],Passengers:[{id:"minecraft:armor_stand",Invulnerable:1b,ShowArms:1b,Invisible:1b,PersistenceRequired:1b,Tags:["body","titan"],Pose:{RightArm:[0f,0f,0f]},Passengers:[{id:"minecraft:slime",Silent:1b,Invulnerable:0b,PersistenceRequired:1b,NoAI:1b,Health:1000f,Size:4,Tags:["neck","titan"],ActiveEffects:[{Id:6b,Amplifier:127b,Duration:1,ShowParticles:0b},{Id:14b,Amplifier:1b,Duration:1,ShowParticles:0b}],Attributes:[{Name:generic.max_health,Base:1000}]}],HandItems:[{id:'minecraft:flint',Count:1b,tag:{CustomModelData:1}},{}]}],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1,ShowParticles:0b}],Attributes:[{Name:generic.max_health,Base:1000},{Name:generic.attack_damage,Base:1}]}],CustomName:'{"text":"Titan"}',ArmorItems:[{},{},{},{id:'minecraft:arrow',Count:1b,tag:{CustomModelData:1}}],ActiveEffects:[{Id:14b,Amplifier:1b,Duration:1,ShowParticles:0b}],Attributes:[{Name:generic.follow_range,Base:200},{Name:generic.movement_speed,Base:0.5},{Name:generic.attack_damage,Base:30}]}
summon spider ~ ~10 ~ {Tags:["kill"]}
