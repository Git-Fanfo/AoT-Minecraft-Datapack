...
execute as @s[tag=mob1,scores={atk_cool=71..140}] at @s run execute at @e[tag=mob1,tag=neck,sort=nearest,limit=1] if entity @a[distance=0..8.5] run function moose:titans/mobs/1/attack_2
