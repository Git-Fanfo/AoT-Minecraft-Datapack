...
# Rotar legs y body
execute as @e[tag=feet,scores={rot_cool=0}] at @s store result entity @e[tag=legs,limit=1,sort=nearest,distance=..5] Rotation[0] float 1 run data get entity @s Rotation[0]
execute as @e[tag=legs] at @s store result entity @e[tag=body,limit=1,sort=nearest,distance=..5] Rotation[0] float 1 run data get entity @s Rotation[0]
# cooldown de 40
...
execute as @e[tag=body] at @s run tp @e[type=spider,tag=kill, sort=nearest,limit=1,distance=..5] ^ ^3.90 ^-1.5
execute as @e[tag=body] at @s store result entity @e[type=spider,tag=kill, sort=nearest,limit=1,distance=..5] Rotation[0] float 1 run data get entity @s Rotation[0]
