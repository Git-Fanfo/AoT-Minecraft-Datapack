...
# cooldown de 40
execute as FanfoYT at FanfoYT run data get entity @e[tag=body,sort=nearest,limit=1] Rotation
execute as FanfoYT at FanfoYT run data get entity @e[tag=legs,sort=nearest,limit=1] Rotation
