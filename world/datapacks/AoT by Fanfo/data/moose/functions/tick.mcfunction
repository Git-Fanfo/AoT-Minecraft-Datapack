...
execute as @e[tag=body] at @s run execute as @s run tp @e[type=spider,tag=kill, sort=nearest,limit=1] ^ ^3.90 ^-1.5
execute as @e[tag=body] at @s run execute as @s run say @s : Hola wapa
execute as @e[tag=body] at @s store result entity @e[type=spider,tag=kill, sort=nearest,limit=1] Rotation[0] float 1 run data get entity @s Rotation[0]
