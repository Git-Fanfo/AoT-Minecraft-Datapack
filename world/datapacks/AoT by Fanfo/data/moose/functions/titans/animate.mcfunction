...
execute if entity @s[tag=attack_2] run function moose:titans/mobs/1/animate/attack_2
execute if entity @s[tag=!attack,tag=!attack_2,tag=walk] run function moose:titans/mobs/1/animate/walk
execute if entity @s[tag=!attack,tag=!attack_2,tag=!walk] run function moose:titans/mobs/1/animate/idle
